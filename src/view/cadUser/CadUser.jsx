...
export default function CadUser() {
  ...
  const schema = yup
    .object()
    .shape({
      name: yup.string().required("Você deve preencher todos os campos"),
      userName: yup.string().required("Você deve preencher todos os campos"),
      email: yup
        .string()
        .required("Você deve preencher todos os campos")
        .matches(),
      password: yup.string().required("Você deve preencher todos os campos"),
      phone: yup.string().required("Você deve preencher todos os campos"),
      ...
      <div className="default-form-container">
        ...
        <div>
          <form
            ...
            onSubmit={handleSubmit((e) => doRequest(e))}
          >
